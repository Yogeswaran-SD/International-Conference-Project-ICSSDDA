  ...
  return (
    <>
      ...
      <section className='max-w-full mx-[150px] lg:py-10 space-y-5'>
        <div >
          <h2 className="hanu-bold text-[30px] text-[#093FB4]">About Our Conference</h2>
        </div>
        ...
        <div className=" lg:py-10 space-y-5 grid lg:grid-cols-2 gap-10">
          <div className="space-y-5">
            <h2 className="hanu-bold text-[30px] text-[#093FB4]">Conference Objective</h2>
            <ul className="list-disc  pop-medium text-[18px] list-inside space-y-5">
              ...
              <li>To explore the challenges and future directions of software development and data science in the age 
of big data and AI.</li>
            </ul>
          </div>
          <div><img src="\public\image\about 1.png" alt=""  className='md:h-100 md:w-100 lg:h-100 lg:w-200 text-center items-center object-cover rounded-2xl'/></div>
        </div>


        <div className="grid lg:grid-cols-2 gap-10 lg:py-10 ">
          <div>
            <img src="public/image/about 2.png" alt="" className='md:h-100 md:w-100 lg:h-100 lg:w-200 text-center items-center object-cover rounded-2xl '/>
          </div>
          <div className="space-y-5">
            <h2  className="hanu-bold text-[30px] text-[#093FB4]">Who Should Attend :</h2>
            <ul className="list-disc  pop-medium text-[18px] list-inside space-y-5">
