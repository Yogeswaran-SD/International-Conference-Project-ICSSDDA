  ...
  return (
    <>
      ...
      <section className='max-w-full mx-[150px]'>
        ...
        <div className='bg-[#093FB4]'>
          <div className='text-[#B2C7F6] text-center py-1'>
            <h2 className='hanu-bold text-[30px]'>Our Distinguished Editorial Board</h2>
          </div>
        </div>
      ...
      <div className='max-w-[80rem]  mx-auto  '>
        <div className='grid grid-cols-3  my-10 space-y-5   '>

          <div className="bg-[url('/image/Editorial-Board.png')] bg-no-repeat  text-center    ">
            
              <h2 className='k2d-bold text-[25px] text-[#093FB4] pl-5'>Dr. Md. Foysal</h2>
              <p className='pop-medium text-[16px] pl-5'>Department of Computer Science</p>
              <p className='pop-medium text-[16px] pl-5'>University of Diponegoro</p>
              <p className='pop-medium text-[16px] pl-5'>Indonesia</p>
            
      </div>
          <div className="bg-[url('/image/Editorial-Board.png')] bg-no-repeat text-center pt-1  ">
            <h2 className='k2d-bold text-[25px] text-[#093FB4]'>Dr. Md. Foysal</h2>
            <p className='pop-medium text-[16px]'>Department of Computer Science</p>
            <p className='pop-medium text-[16px]'>University of Diponegoro</p>
            <p className='pop-medium text-[16px]'>Indonesia</p>
          </div >
          <div className="bg-[url('/image/Editorial-Board.png')] bg-no-repeat text-center pt-1  ">
            <h2 className='k2d-bold text-[25px] text-[#093FB4]'>Dr. Md. Foysal</h2>
            <p className='pop-medium text-[16px]'>Department of Computer Science</p>
